...
void hwmm_layer4(ap_fixed<32,24> input[1][n_layer3], const ap_fixed<32,24> weights[n_layer3][n_layer4], ap_fixed<32,24> output[1][n_layer4])
{
    col: for (int j = 0; j < n_layer3; ++j) {
#pragma HLS UNROLL factor=4
      ap_fixed<32,24> sum = 0;

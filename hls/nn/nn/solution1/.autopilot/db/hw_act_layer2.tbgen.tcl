...
set C_modelName {hw_act_layer2}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_0_V int 32 regular {array 32 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ output_0_V_address0 sc_out sc_lv 5 signal 0 } 
	...
	{ output_0_V_address1 sc_out sc_lv 5 signal 0 } 
...
set Spec2ImplPortList { 
	output_0_V { ap_memory {  { output_0_V_address0 mem_address 1 5 }  { output_0_V_ce0 mem_ce 1 1 }  { output_0_V_we0 mem_we 1 1 }  { output_0_V_d0 mem_din 1 32 }  { output_0_V_q0 mem_dout 0 32 }  { output_0_V_address1 MemPortADDR2 1 5 }  { output_0_V_ce1 MemPortCE2 1 1 }  { output_0_V_we1 MemPortWE2 1 1 }  { output_0_V_d1 MemPortDIN2 1 32 }  { output_0_V_q1 MemPortDOUT2 0 32 } } }
}

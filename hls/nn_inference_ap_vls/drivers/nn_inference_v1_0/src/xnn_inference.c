...
u32 XNn_inference_Get_input_img_BaseAddress(XNn_inference *InstancePtr) {
    ...
    return (InstancePtr->Control_BaseAddress + XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_BASE);
}
...
u32 XNn_inference_Get_input_img_HighAddress(XNn_inference *InstancePtr) {
    ...
    return (InstancePtr->Control_BaseAddress + XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_HIGH);
}
...
u32 XNn_inference_Get_input_img_TotalBytes(XNn_inference *InstancePtr) {
    ...
    return (XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_HIGH - XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_BASE + 1);
}
...
u32 XNn_inference_Get_input_img_BitWidth(XNn_inference *InstancePtr) {
    ...
    return XNN_INFERENCE_CONTROL_WIDTH_INPUT_IMG;
}
...
u32 XNn_inference_Get_input_img_Depth(XNn_inference *InstancePtr) {
    ...
    return XNN_INFERENCE_CONTROL_DEPTH_INPUT_IMG;
}
...
u32 XNn_inference_Write_input_img_Words(XNn_inference *InstancePtr, int offset, word_type *data, int length) {
    ...
    if ((offset + length)*4 > (XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_HIGH - XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Control_BaseAddress + XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}
...
u32 XNn_inference_Read_input_img_Words(XNn_inference *InstancePtr, int offset, word_type *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Control_BaseAddress + XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_BASE + (offset + i)*4);
    }
    return length;
}
...
u32 XNn_inference_Write_input_img_Bytes(XNn_inference *InstancePtr, int offset, char *data, int length) {
    ...
    if ((offset + length) > (XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_HIGH - XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Control_BaseAddress + XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_BASE + offset + i) = *(data + i);
    }
    return length;
}
...
u32 XNn_inference_Read_input_img_Bytes(XNn_inference *InstancePtr, int offset, char *data, int length) {
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Control_BaseAddress + XNN_INFERENCE_CONTROL_ADDR_INPUT_IMG_BASE + offset + i);
    }
    return length;
}

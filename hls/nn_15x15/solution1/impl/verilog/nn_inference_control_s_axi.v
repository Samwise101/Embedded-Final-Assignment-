...
#(parameter
    ...
    input  wire [7:0]                    input_img_address0,
...
localparam
    ...
    ADDR_IER            = 11'h008,
    ADDR_ISR            = 11'h00c,
    ADDR_INPUT_IMG_BASE = 11'h400,
    ADDR_INPUT_IMG_HIGH = 11'h7ff,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [7:0]                    int_input_img_address0;
    ...
    wire [7:0]                    int_input_img_address1;
...
//------------------------Instantiation------------------
// int_input_img
nn_inference_control_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 225 )
) int_input_img (
    .clk0     ( ACLK ),
...
assign int_input_img_address1 = ar_hs? raddr[9:2] : waddr[9:2];
...
module nn_inference_control_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)

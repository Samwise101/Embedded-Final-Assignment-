...
HD_PWD='/tools/Xilinx/MPSoC4Drones/hdl/projects/u96v2_sbc_mp4d_2020_2/u96v2_sbc_mp4d.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u96v2_sbc_mp4d_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u96v2_sbc_mp4d_wrapper.tcl
